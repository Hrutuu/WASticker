...
import static com.example.stickerapp.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
import static com.example.stickerapp.StickerContentProvider.IOS_APP_DOWNLOAD_LINK_IN_QUERY;
import static com.example.stickerapp.StickerContentProvider.LICENSE_AGREENMENT_WEBSITE;
import static com.example.stickerapp.StickerContentProvider.PRIVACY_POLICY_WEBSITE;
import static com.example.stickerapp.StickerContentProvider.PUBLISHER_EMAIL;
import static com.example.stickerapp.StickerContentProvider.PUBLISHER_WEBSITE;
import static com.example.stickerapp.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
import static com.example.stickerapp.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
import static com.example.stickerapp.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
import static com.example.stickerapp.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
import static com.example.stickerapp.StickerContentProvider.STICKER_PACK_NAME_IN_QUERY;
import static com.example.stickerapp.StickerContentProvider.STICKER_PACK_PUBLISHER_IN_QUERY;
...
public class StickerPackLoader {
    ...
    private static List<Sticker> fetchFromContentProviderForStickers(String identifier, ContentResolver contentResolver) {
        ...
        if (cursor != null && cursor.getCount() > 0) {
            cursor.moveToFirst();
            do {
                final String name = cursor.getString(cursor.getColumnIndexOrThrow(STICKER_FILE_NAME_IN_QUERY));final String emojisConcatenated = cursor.getString(cursor.getColumnIndexOrThrow(STICKER_FILE_EMOJI_IN_QUERY));
